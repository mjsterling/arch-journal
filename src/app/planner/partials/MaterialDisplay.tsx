...
export const MaterialDisplay: MaterialDisplay = (material) => {
  ...
  return (
    <div key={material.name} className="flex flex-col gap-2 justify-center items-center">
      <Icon
      ...
      <span
        className={[
          ...
          !material.isArchMaterial ? 'text-yellow-500' : material.diff < 0 ? 'text-red-500' : 'text-green-700',
        ].join(' ')}
      >
